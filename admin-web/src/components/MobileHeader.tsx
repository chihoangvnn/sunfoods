...
import { Home, Search, ShoppingCart, MessageSquare, Users, Activity } from 'lucide-react';
...
export function MobileHeader({ 
  ...
  return (
    <div className="sticky top-0 z-50 bg-gradient-to-r from-green-600 to-green-700 shadow-lg lg:hidden">
