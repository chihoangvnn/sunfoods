...
const MobileChatBot = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-x-0 bottom-0 z-40 bg-white flex flex-col h-[85vh] sm:inset-auto sm:bottom-24 sm:right-6 sm:w-96 sm:h-[600px] sm:rounded-2xl shadow-2xl border-t sm:border border-gray-200 animate-in slide-in-from-bottom-5 duration-300">
          {/* Header */}
