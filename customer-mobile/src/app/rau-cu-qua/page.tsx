...
export default function RauCuQuaPage() {
  ...
  return (
    <div className="min-h-screen bg-emerald-50 pb-20">
      ...
      <CategoryNavigationMenu activeCategory="rau-cu-qua" />
        ...
        {isLoading ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {Array.from({ length: 8 }).map((_, index) => (
              <div key={index} className="bg-white rounded-3xl shadow-md border border-emerald-100 overflow-hidden">
                <div className="aspect-square bg-emerald-200 animate-pulse" />
                <div className="p-4 space-y-3">
                  <div className="h-4 bg-emerald-200 rounded animate-pulse" />
                  <div className="h-6 bg-emerald-200 rounded w-2/3 animate-pulse" />
                  <div className="h-10 bg-emerald-200 rounded-full animate-pulse" />
                </div>
              </div>
            ))}
          </div>
